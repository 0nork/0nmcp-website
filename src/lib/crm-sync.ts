...
function emailLayout(params: {
  ...
  const cta = params.ctaUrl && params.ctaText
    ? `<div style="text-align:center;margin:28px 0;">
        <a href="${params.ctaUrl}" style="display:inline-block;padding:14px 36px;background:#6EE05A;color:#0B0F19;font-weight:800;font-size:15px;border-radius:10px;text-decoration:none;letter-spacing:-0.01em;mso-padding-alt:14px 36px;">
          ${params.ctaText}
        </a>
      </div>`
    : ''
                    ...
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
                      <tr>
                        <td align="center" style="padding-bottom:6px;">
                          <span style="font-size:32px;font-weight:900;color:#6EE05A;font-family:'Courier New',Courier,monospace;letter-spacing:-0.03em;">0n</span><span style="font-size:22px;font-weight:700;color:#e0e0e0;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',sans-serif;margin-left:3px;">MCP</span>
                        </td>
                      </tr>
                      <tr>
                        <td align="center">
                ...
                <tr>
                  <td style="padding:20px 32px;background:#0c0c14;border:1px solid #1a1a2e;border-top:none;border-bottom:none;text-align:center;">
                    <table role="presentation" cellpadding="0" cellspacing="0" align="center">
                      <tr>
                        <td style="padding:0 8px;"><a href="https://www.0nmcp.com" style="color:#6EE05A;font-size:11px;text-decoration:none;font-weight:600;">Website</a></td>
                        <td style="color:#333;font-size:11px;">&middot;</td>
                        <td style="padding:0 8px;"><a href="https://0n.app.clientclub.net/communities/groups/the-0nboard/home" style="color:#6EE05A;font-size:11px;text-decoration:none;font-weight:600;">0nBoard</a></td>
                        <td style="color:#333;font-size:11px;">&middot;</td>
                        <td style="padding:0 8px;"><a href="https://www.0nmcp.com/forum" style="color:#6EE05A;font-size:11px;text-decoration:none;font-weight:600;">Forum</a></td>
                        <td style="color:#333;font-size:11px;">&middot;</td>
                        <td style="padding:0 8px;"><a href="https://github.com/0nork/0nMCP" style="color:#6EE05A;font-size:11px;text-decoration:none;font-weight:600;">GitHub</a></td>
                        <td style="color:#333;font-size:11px;">&middot;</td>
                        <td style="padding:0 8px;"><a href="https://npmjs.com/package/0nmcp" style="color:#6EE05A;font-size:11px;text-decoration:none;font-weight:600;">npm</a></td>
                      </tr>
                    </table>
                  </td>
                </tr>
                ...
                <tr>
                  <td style="padding:20px 32px 28px;background:#0a0a10;border-radius:0 0 16px 16px;border:1px solid #1a1a2e;border-top:none;text-align:center;">
                    ...
                    <p style="font-size:10px;color:#444;line-height:1.6;margin:0;">
                      <a href="https://www.0nmcp.com/account" style="color:#6EE05A;text-decoration:none;">Manage preferences</a>
                      &nbsp;&middot;&nbsp;
    ...
    html: emailLayout({
      ...
      body: `
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 8px;">
          <tr><td style="padding:6px 0;font-size:13px;color:#bbb;"><span style="color:#6EE05A;margin-right:8px;">&#10003;</span> ${STATS_DISPLAY.tools} tools across ${STATS_DISPLAY.services} services</td></tr>
          <tr><td style="padding:6px 0;font-size:13px;color:#bbb;"><span style="color:#6EE05A;margin-right:8px;">&#10003;</span> Free interactive courses</td></tr>
          <tr><td style="padding:6px 0;font-size:13px;color:#bbb;"><span style="color:#6EE05A;margin-right:8px;">&#10003;</span> Community forum access</td></tr>
          <tr><td style="padding:6px 0;font-size:13px;color:#bbb;"><span style="color:#6EE05A;margin-right:8px;">&#10003;</span> Workflow builder</td></tr>
        </table>
      `,
  ...
  return sendTransactionalEmail({
    ...
    html: emailLayout({
      ...
      body: `
        ...
        <div style="background:#111827;border:1px solid #1a1a2e;border-radius:10px;padding:16px 20px;margin:0 0 20px;">
          <p style="font-size:12px;color:#6EE05A;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;margin:0 0 10px;">Quick Start</p>
        ...
        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="margin:0 0 8px;">
          <tr>
            <td style="padding:8px 0;font-size:13px;color:#999;border-bottom:1px solid #1a1a2e;">
              <a href="https://www.0nmcp.com/learn/getting-started" style="color:#6EE05A;text-decoration:none;font-weight:600;">Take the Getting Started course</a>
              <span style="color:#555;margin-left:6px;">(free, 15 min)</span>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 0;font-size:13px;color:#999;border-bottom:1px solid #1a1a2e;">
              <a href="https://www.0nmcp.com/turn-it-on" style="color:#6EE05A;text-decoration:none;font-weight:600;">Turn it 0n</a>
              <span style="color:#555;margin-left:6px;">&mdash; connect your services</span>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 0;font-size:13px;color:#999;border-bottom:1px solid #1a1a2e;">
              <a href="https://0n.app.clientclub.net/communities/groups/the-0nboard/home" style="color:#6EE05A;text-decoration:none;font-weight:600;">Join the 0nBoard</a>
              <span style="color:#555;margin-left:6px;">&mdash; our community hub</span>
            </td>
          </tr>
          <tr>
            <td style="padding:8px 0;font-size:13px;color:#999;">
              <a href="https://www.0nmcp.com/forum" style="color:#6EE05A;text-decoration:none;font-weight:600;">Browse the forum</a>
            </td>
          </tr>
        </table>
      `,
