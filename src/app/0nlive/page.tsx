...
export default function ZeroNLivePage() {
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', color: '#e5e5e5', fontFamily: "'Inter', -apple-system, sans-serif" }}>
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '60px 24px 80px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 48 }}>
          <div style={{
            ...
            fontSize: 22, fontWeight: 800, color: '#7ed957',
            fontFamily: "'JetBrains Mono', monospace",
          }}>0n</div>
          <h1 style={{ fontSize: 32, fontWeight: 800, marginBottom: 8, letterSpacing: '-0.02em' }}>
            Command Center <span style={{ color: '#7ed957' }}>v4.2</span>
          </h1>
        ...
        <div style={{
          ...
          <h2 style={{ fontSize: 18, fontWeight: 700, marginBottom: 16, display: 'flex', alignItems: 'center', gap: 8 }}>
            <span style={{ color: '#7ed957' }}>&#x25B6;</span> Quick Install
          </h2>

          <div style={{ background: '#0a0a0a', borderRadius: 8, padding: 20, border: '1px solid #222', marginBottom: 20 }}>
            <p style={{ color: '#888', fontSize: 11, textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 700, marginBottom: 12 }}>
              Terminal — copy &amp; paste
            </p>
            <pre style={{
              fontFamily: "'JetBrains Mono', monospace", fontSize: 13, color: '#7ed957',
...
node server.js`}</pre>
        ...
        <div style={{
          ...
          <div style={{ background: '#0a0a0a', borderRadius: 8, padding: 20, border: '1px solid #222' }}>
            <pre style={{
...
# OAUTH_GOOGLE_CLIENT_SECRET=`}</pre>
        ...
        <div style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
            {[
              { label: 'Engines', value: '12', color: '#7ed957', items: 'Reddit, LinkedIn, GitHub, Outreach, OAuth, Onboarding...' },
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            {[
              { title: 'Zero-Knowledge Capability Proxy', desc: 'Credentials borrowed in-memory, wiped after each call. Never in logs, never at rest.', color: '#7ed957' },
              ...
              { title: 'Desktop App', desc: 'macOS .app bundle. Double-click to launch, Cmd+Q to stop. Green 0n icon.', color: '#7ed957' },
            ].map((f) => (
        ...
        <div style={{
          ...
          <h3 style={{ fontSize: 14, fontWeight: 700, marginBottom: 8, color: '#7ed957' }}>
            macOS SSL Note
          </h3>
          <p style={{ color: '#888', fontSize: 12, lineHeight: 1.6 }}>
          ...
          <code style={{
            ...
            background: '#0a0a0a', borderRadius: 6, border: '1px solid #222',
            fontFamily: "'JetBrains Mono', monospace", fontSize: 12, color: '#7ed957',
        ...
        <div style={{ textAlign: 'center', paddingTop: 24, borderTop: '1px solid #222' }}>
          <p style={{ fontSize: 11, color: '#555' }}>
            Built by <span style={{ color: '#888' }}>RocketOpp LLC</span> &middot; Powered by <span style={{ color: '#7ed957' }}>0nMCP</span>
          </p>
