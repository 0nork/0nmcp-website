        ...
        <div className="max-w-[900px] mx-auto">
          ...
          <div className="grid gap-[18px]" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))' }}>
            {[
              ...
              { icon: <ServerIcon size={24} color={C.purple} />, title: 'Live MCP Server', desc: '1,598+ tools, 106 services, real-time execution. The largest MCP server ever built.', accent: C.purple },
