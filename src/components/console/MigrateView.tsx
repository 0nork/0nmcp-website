    ...
    <div style={{ maxWidth: 800, margin: '0 auto' }}>
      ...
      {viewState === 'idle' && (
        <div
          ...
          style={{
            border: `2px dashed ${dragOver ? 'var(--accent, #6EE05A)' : 'var(--border, #2a2a3a)'}`,
            borderRadius: 16,
            padding: '48px 24px',
            textAlign: 'center',
            cursor: 'pointer',
        ...
        <div>
          ...
          <div
            style={{
              ...
              border: '1px solid var(--accent, #6EE05A)30',
            }}
          >
            <span
              style={{
                ...
                color: 'var(--accent, #6EE05A)',
                background: 'var(--accent, #6EE05A)18',
                padding: '2px 8px',
                borderRadius: 4,
              }}
            >
