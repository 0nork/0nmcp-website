        ...
        <section className="mb-10">
          ...
          <div className="rounded-xl p-5" style={{ background: 'var(--bg-card)', border: '1px solid var(--border)' }}>
            <div className="rounded-lg p-4" style={{ background: 'var(--bg-primary)' }}>
              ...
              <code className="text-xs font-mono block" style={{ color: '#6EE05A' }}>   log.append(transfer_id, sender, recipient, layers, sig, timestamp)</code>
            </div>
          </div>
        </section>
...
export async function generateMetadata(): Promise<Metadata> {
  return withCro9Meta('/security/transfer', metadataBase)
}
