...
const ACTIONS: QuickAction[] = [
  ...
  { key: 'credentials', label: 'Vault', desc: 'Manage API keys', icon: <KeyRound size={20} />, color: '#7ed957' },
    ...
    <div style={{ padding: '2rem 2rem 3rem', maxWidth: 960, margin: '0 auto', width: '100%' }}>
      ...
      <div className="dash-stats" style={{
        ...
        {[
          ...
          { label: 'Vault Keys', value: String(connectedCount), color: '#7ed957' },
          ...
          {recentHistory.length > 0 ? recentHistory.slice(0, 8).map((entry, i) => (
            <div key={entry.id} style={{
              ...
              <div style={{
                ...
                background: entry.type === 'error' ? '#ef4444' : entry.type === 'workflow' ? '#00d4ff' : '#7ed957',
              }} />
              <span style={{
                flex: 1,
                fontSize: '0.8rem',
