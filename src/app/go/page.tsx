...
export const metadata: Metadata = {
  title: '0nMCP — The AI Operating System for Business | 850 Tools, 53 Services, One Command',
  description:
            ...
            '@graph': [
              {
                ...
                featureList: '850 tools, 53 services, AES-256-GCM encryption, patent-pending vault, AI chat, visual builder, multi-persona reasoning',
                author: { '@type': 'Organization', name: 'RocketOpp LLC', url: 'https://rocketopp.com' },
              },
              {
                '@type': 'FAQPage',
                mainEntity: [
                  { '@type': 'Question', name: 'What is 0nMCP?', acceptedAnswer: { '@type': 'Answer', text: '0nMCP is a Universal AI API Orchestrator that connects 53 services (850 tools) into one platform. You describe what you want done in plain English, and AI executes it across all your connected services simultaneously.' } },
                  ...
                  { '@type': 'Question', name: 'What services does 0nMCP connect to?', acceptedAnswer: { '@type': 'Answer', text: '53 services including Stripe, Gmail, Slack, HubSpot, Shopify, Google Sheets, Discord, Twilio, Notion, Airtable, OpenAI, Anthropic, Supabase, and many more.' } },
