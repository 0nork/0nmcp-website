...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      `${STATS_DISPLAY.tools} tools across ${STATS_DISPLAY.services} services. One natural language command triggers Stripe, SendGrid, and CRM simultaneously. Patent-pending encryption. Free to start.`,
  ...
  twitter: {
    ...
    description: `${STATS_DISPLAY.tools} tools. ${STATS_DISPLAY.services} services. One command. Describe what you want — AI does it.`,
  },
            ...
            '@graph': [
              {
                ...
                description: `Universal AI API Orchestrator — ${STATS_DISPLAY.tools} tools across ${STATS_DISPLAY.services} services in one command.`,
                offers: [
                ...
                featureList: `${STATS_DISPLAY.tools} tools, ${STATS_DISPLAY.services} services, AES-256-GCM encryption, patent-pending vault, AI chat, visual builder, multi-persona reasoning`,
                author: { '@type': 'Organization', name: 'RocketOpp LLC', url: 'https://rocketopp.com' },
              },
              {
                '@type': 'FAQPage',
                mainEntity: [
                  { '@type': 'Question', name: 'What is 0nMCP?', acceptedAnswer: { '@type': 'Answer', text: `0nMCP is a Universal AI API Orchestrator that connects ${STATS_DISPLAY.services} services (${STATS_DISPLAY.tools} tools) into one platform. You describe what you want done in plain English, and AI executes it across all your connected services simultaneously.` } },
                  ...
                  { '@type': 'Question', name: 'What services does 0nMCP connect to?', acceptedAnswer: { '@type': 'Answer', text: `${STATS_DISPLAY.services} services including Stripe, Gmail, Slack, HubSpot, Shopify, Google Sheets, Discord, Twilio, Notion, Airtable, OpenAI, Anthropic, Supabase, and many more.` } },
