...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const description = `Connect ${service.name} to ${total > 0 ? total + ' automations across ' : ''}53 services using AI-powered orchestration. No code required — describe what you want and 0nMCP handles the rest.`
