...
export default async function ComparisonPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const productJsonLd = {
    ...
    '@type': 'Product',
    name: '0nMCP',
    description: `Universal AI API Orchestrator — ${STATS_DISPLAY.tools} tools, ${STATS_DISPLAY.services} services, one npm install.`,
    ...
    <div className="pt-28 pb-24 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="rounded-xl p-6 text-center" style={{ background: 'rgba(255,107,53,0.05)', border: '1px solid rgba(255,107,53,0.15)' }}>
          ...
          <p className="text-xs mb-4" style={{ color: 'var(--text-secondary)' }}>{STATS_DISPLAY.tools} tools. {STATS_DISPLAY.services} services. Free and open source.</p>
          <Link
            href="/turn-it-on"
