    ...
    <div style={{ background: 'var(--bg-secondary)', minHeight: '100vh', paddingTop: '5rem' }}>
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        <p style={{ fontSize: 17, color: 'var(--text-muted)', lineHeight: 1.8, marginBottom: 32 }}>
          Connect any AI model to <strong>54 services</strong> through the Model Context Protocol. Stripe, CRM, Slack, GitHub, Supabase — all accessible with <code style={{ background: 'var(--bg-secondary)', padding: '2px 6px', borderRadius: 4 }}>npx 0nmcp@latest</code>. Powered by 4 patented technologies. MIT licensed. Open source.
        </p>
      </div>
