...
export default function FAQSection({
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer:
        '0nMCP has no monthly fees, runs locally on your machine (your data never touches our servers), supports 1,640+ tools across 111 services, and lets you describe workflows in plain English instead of building multi-step automations by hand.',
    },
    {
