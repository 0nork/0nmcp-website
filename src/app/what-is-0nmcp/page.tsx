...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    title: 'What Is 0nMCP? The AI Tool That Does Your Business Work For You',
    description:
      '0nMCP gives your AI assistant 1,598+ tools to get real work done — email, CRM, Stripe, Supabase, and more. 0nCore is the engine.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: '0nMCP — 1,598+ AI tools, one engine',
      },
    ],
  },
  twitter: {
    ...
    title: 'What Is 0nMCP? The AI Tool That Does Your Business Work For You',
    description:
      '1,598+ tools. 106 services. One AI engine. 0nMCP makes your AI actually do things — not just talk about them.',
  ...
  const ld = {
    ...
    '@graph': [
      ...
      },
      {
        ...
        description:
          '0nMCP gives your AI assistant 1,598+ tools to get real work done — email, CRM, payments, databases, and more. 0nCore is the engine.',
      ...
      },
      {
        ...
        description:
          '0nMCP is an AI orchestration engine with 1,598+ tools across 106 services. It lets any AI assistant take real actions — send emails, manage contacts, charge payments, query databases, and more.',
        offers: {
          '@type': 'Offer',
          price: '0',
          priceCurrency: 'USD',
