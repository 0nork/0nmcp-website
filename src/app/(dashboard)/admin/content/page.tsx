          ...
          >
            ...
            <div style={{ display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              ...
              {selectedItem.status !== 'approved' && (
                <button onClick={() => handleAction(selectedItem.id, 'approved')} style={btnStyle('#6EE05A')}>Approve</button>
              )}
              ...
              {selectedItem.posted_url && (
                <a href={selectedItem.posted_url} target="_blank" rel="noopener noreferrer" style={{ ...btnStyle('#6EE05A'), textDecoration: 'none', display: 'inline-block' }}>View Post</a>
              )}
