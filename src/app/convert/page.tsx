...
const STEPS = [
  ...
  { num: '03', title: 'Run', desc: 'Get a portable .0n workflow file — works with 0nMCP and 545 tools instantly' },
]

const VALUE_PROPS = [
  { title: 'Platform Independent', desc: 'Your workflows run anywhere — no vendor lock-in, ever' },
  { title: '545 Tools Built In', desc: '26 services, 13 categories — everything connected from day one' },
