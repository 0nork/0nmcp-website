    ...
    <div style={{
      ...
      <div style={{
        ...
        <Link
          ...
          onMouseEnter={(e) => {
            ...
            e.currentTarget.style.boxShadow = '0 0 20px rgba(110, 224, 90, 0.15)'
          }}
          onMouseLeave={(e) => {
      ...
      <style>{`
        @keyframes switchShowcaseGlow {
          0% {
            box-shadow: 0 0 0 rgba(110, 224, 90, 0);
          }
          100% {
            box-shadow: 0 0 30px rgba(110, 224, 90, 0.06), 0 0 60px rgba(110, 224, 90, 0.03);
          }
        }
