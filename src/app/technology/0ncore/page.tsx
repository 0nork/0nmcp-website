    ...
    <div className="pt-28 pb-24 px-4 md:px-8">
      <div className="max-w-4xl mx-auto">
        ...
        <nav className="text-xs mb-4 flex items-center gap-1.5 text-[var(--text-muted)]" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <span className="text-[#ff6b35]">0nCore</span>
        </nav>

        {/* Hero */}
        <div className="heading-glow">
          <span className="text-xs font-mono uppercase tracking-widest mb-3 block text-[#ff6b35]">
        ...
        <section className="rounded-2xl p-6 md:p-8 mb-10 bg-[var(--bg-card)] border border-[var(--border)]">
          ...
          <p className="text-sm leading-relaxed mb-4 text-[var(--text-secondary)]">
            <strong className="text-[var(--text-primary)]">0nCore changes that.</strong> It learns your industry, your style, your vocabulary — then generates content that sounds like you actually wrote it. Emails, follow-ups, social posts, proposals — all in your authentic voice.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="rounded-2xl p-6 bg-[var(--bg-card)] border border-[var(--border)]">
              <div className="flex items-center gap-3 mb-4">
                <div className="w-10 h-10 rounded-xl flex items-center justify-center text-lg font-black bg-[rgba(255,107,53,0.15)] text-[#ff6b35] border border-[rgba(255,107,53,0.3)]">
                  1
                </div>
                <div>
                  <h3 className="font-bold text-[#ff6b35]">Voice Learning</h3>
                  <span className="text-xs text-[var(--text-muted)]">Profile-Adaptive Content Generation</span>
                </div>
              </div>
              <p className="text-sm leading-relaxed mb-4 text-[var(--text-secondary)]">
                When you connect your account, 0nCore analyzes how you communicate. What words you use. What industry you&apos;re in. How formal or casual your tone is. It builds a <strong className="text-[var(--text-primary)]">voice profile</strong> unique to you.
              </p>
              <div className="grid sm:grid-cols-3 gap-3">
                {[
                  ...
                  <div key={f.label} className="rounded-lg p-3 bg-[rgba(255,107,53,0.05)] border border-[rgba(255,107,53,0.1)]">
                    <h4 className="text-xs font-bold mb-1 text-[#ff6b35]">{f.label}</h4>
            ...
            <div className="rounded-2xl p-6 bg-[var(--bg-card)] border border-[var(--border)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-[#ff6b35]">Language Optimization</h3>
                  <span className="text-xs text-[var(--text-muted)]">Language Variation Optimization System</span>
                </div>
              </div>
              <p className="text-sm leading-relaxed mb-4 text-[var(--text-secondary)]">
            ...
            <div className="rounded-2xl p-6 bg-[var(--bg-card)] border border-[var(--border)]">
              <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                  <h3 className="font-bold text-[#ff6b35]">Cross-User Intelligence</h3>
                  <span className="text-xs text-[var(--text-muted)]">Conversion Intelligence Aggregator</span>
                </div>
              </div>
              <p className="text-sm leading-relaxed mb-4 text-[var(--text-secondary)]">
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            <div className="rounded-xl p-5 bg-[rgba(255,68,68,0.05)] border border-[rgba(255,68,68,0.15)]">
              <h3 className="font-bold text-sm mb-3 text-[#ff4444]">Without 0nCore</h3>
              ...
              <p className="text-xs mt-2 text-[var(--text-muted)]">Generic. Sounds like every other AI email.</p>
            </div>
            <div className="rounded-xl p-5 bg-[rgba(126,217,87,0.05)] border border-[rgba(126,217,87,0.15)]">
              <h3 className="font-bold text-sm mb-3 text-[#6EE05A]">With 0nCore</h3>
              <p className="text-sm italic text-[var(--text-secondary)]">
              ...
              <p className="text-xs mt-2 text-[var(--text-muted)]">Sounds like you. Because it learned from you.</p>
            </div>
          </div>
        </section>

        {/* Privacy */}
        <section className="rounded-2xl p-6 md:p-8 mb-10 bg-[linear-gradient(135deg,rgba(255,107,53,0.06),rgba(167,139,250,0.04))] border border-[rgba(255,107,53,0.15)]">
          <h2 className="text-xl font-bold mb-4 text-[var(--text-primary)]">
          ...
          <div className="space-y-3">
            {[
              ...
              <div key={point} className="flex gap-3">
                <span className="text-[#6EE05A]">&#10003;</span>
        ...
        <section className="mb-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Link href="/technology/0nplex" className="rounded-xl p-5 no-underline group bg-[var(--bg-card)] border border-[var(--border)]">
              <h3 className="font-bold text-sm mb-1 group-hover:underline text-[#00d4ff]">0nPlex</h3>
              <p className="text-xs text-[var(--text-muted)]">7 AI personas for multi-perspective reasoning</p>
            </Link>
            <Link href="/turn-it-on" className="rounded-xl p-5 no-underline group bg-[var(--bg-card)] border border-[var(--border)]">
              <h3 className="font-bold text-sm mb-1 group-hover:underline text-[var(--accent)]">Turn it 0n</h3>
              <p className="text-xs text-[var(--text-muted)]">Browse all capabilities powered by 0nCore</p>
            </Link>
          </div>
        </section>

        {/* CTA */}
        <section className="text-center rounded-2xl p-8 md:p-12 mb-10 bg-[linear-gradient(135deg,rgba(255,107,53,0.08),rgba(126,217,87,0.06))] border border-[rgba(255,107,53,0.15)]">
          ...
          <div className="flex flex-wrap gap-3 justify-center">
            ...
            <Link href="/technology" className="no-underline px-6 py-2.5 rounded-xl font-bold text-sm bg-[var(--bg-card)] border border-[var(--border)] text-[var(--text-primary)]">
        ...
        <div className="flex items-center justify-between pt-6 border-t border-[var(--border)]">
          ...
          <Link href="/technology" className="text-sm font-bold no-underline text-[var(--text-muted)]">
            All Technology &rarr;
          </Link>
        </div>
      </div>
