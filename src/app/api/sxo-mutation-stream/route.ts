...
const MUTATIONS = [
  {
    requiresUpdate: true,
    newTitle: '0nMCP — Universal AI API Orchestrator | 1,598+ Tools, 111 Services',
    newH1: '0nMCP — The Most Comprehensive MCP Server',
    newBluf: '0nMCP connects <strong>1,598+ tools</strong> across <strong>106 services</strong> to any AI model — Claude, Gemini, Grok, Cursor, and more. Zero configuration. Source-available. Powered by 4 patent-pending technologies. The only MCP server built for real business automation.',
  ...
  },
  {
    ...
    newBluf: 'Available now on <strong>npm</strong> and <strong>GitHub</strong>. Source-available. The community-driven MCP server with <strong>1,598+ tools</strong>, <strong>106 services</strong>, and the deepest CRM integration of any orchestrator. Cisco called the competition a "security nightmare" — we built the secure alternative.',
    changeLog: 'GitHub repository stats synced',
    newTableRows: `
      <tr class="border-b"><td class="p-4 font-medium">Source</td><td class="p-4 text-gray-500">Closed / proprietary</td><td class="p-4 font-bold" style="color:#16a34a">source-available core · 0ncore.com</td></tr>
