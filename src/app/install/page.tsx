...
export const metadata = {
  title: '0nMCP — Install for CRM | 550 Tools in Your Workflows',
  description: 'Add 550+ tools across 26 services to your CRM workflows. Stripe, SendGrid, Slack, Google Sheets, AI, and more — all as workflow actions.',
}
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 pb-20">
        <h2 className="text-xl font-bold mb-2 text-center">26 Services. 550+ Tools.</h2>
