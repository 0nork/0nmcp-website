...
const L: Record<string, string> = {
  ...
  openai: `<svg viewBox="0 0 32 32"><rect rx="6" width="32" height="32" fill="#0B0F19"/><path d="M23.9 14.3a5.1 5.1 0 00-.4-4.2 5.2 5.2 0 00-5.6-2.5 5.1 5.1 0 00-3.8-1.7 5.2 5.2 0 00-5 3.6 5.1 5.1 0 00-3.4 2.5 5.2 5.2 0 00.6 5.9 5.1 5.1 0 00.4 4.2 5.2 5.2 0 005.6 2.5A5.1 5.1 0 0016.1 26a5.2 5.2 0 005-3.6 5.1 5.1 0 003.4-2.5 5.2 5.2 0 00-.6-5.6z" fill="none" stroke="#10a37f" stroke-width="1.5"/></svg>`,
...
const SVC: Record<string, SvcDef> = {
  crm:{l:'Rocket+',logo:'rocketplus',c:'#ff6b35',d:'All-in-one CRM for contacts, pipelines, workflows, calendars, invoicing, and automation.',cap:['Contacts','Pipelines','Workflows','Calendar','Invoicing','SMS/Email','Opportunities','Webhooks'],f:[{k:'client_id',lb:'Client ID',ph:'690ffe...',h:'Marketplace app ID',lk:'#',ll:'Marketplace → My Apps'},{k:'client_secret',lb:'Client Secret',ph:'xxxx-xxxx',s:1,h:'OAuth secret',lk:'#',ll:'My Apps → Settings → Secret'}]},
