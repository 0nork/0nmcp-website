...
export function Logo0nMCP({ height = 32, className }: LogoProps) {
  ...
  return (
    ...
    >
      {/* Icon box */}
      <rect x="0" y="2" width="28" height="28" rx="6" fill="#0f1419" stroke="#7ed957" strokeWidth="1.2" strokeOpacity="0.5" />
      <text x="14" y="22" textAnchor="middle" fill="#7ed957" fontSize="16" fontWeight="700" fontFamily="'JetBrains Mono', monospace">0n</text>
      {/* MCP text */}
...
export function Icon0n({ size = 24, className }: { size?: number; className?: string }) {
  return (
    ...
    >
      ...
      <text x="20" y="27" textAnchor="middle" fill="#7ed957" fontSize="20" fontWeight="700" fontFamily="'JetBrains Mono', monospace">0n</text>
    </svg>
  )
}
...
export function LogoConsole({ height = 22, className }: LogoProps) {
  ...
  return (
    ...
    >
      <text x="0" y="17" fill="#7ed957" fontSize="14" fontWeight="700" fontFamily="'JetBrains Mono', monospace">0n</text>
