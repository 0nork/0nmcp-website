...
export default function OnPressSuccessPage() {
  return (
    <div style={{ background: '#0A0E17', color: '#E8E8E8', minHeight: '100vh', fontFamily: "'Inter', system-ui, sans-serif", display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div style={{ textAlign: 'center', maxWidth: 500, padding: 40 }}>
        ...
        <div style={{ background: '#111622', border: '1px solid #1a1f2e', borderRadius: 12, padding: 24, textAlign: 'left', marginBottom: 24 }}>
