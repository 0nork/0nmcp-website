      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '0 1.5rem 4rem' }}>
        ...
        <div style={{ marginTop: 16, marginBottom: 40 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 16 }}>
            <div style={{
              width: 56, height: 56, borderRadius: 14, background: '#10a37f',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              color: '#fff', fontSize: 20, fontWeight: 900,
              boxShadow: '0 8px 24px rgba(16,163,127,0.25)',
            }}>GPT</div>
            <div>
              <h1 style={{ fontSize: 32, fontWeight: 900, color: '#1a1a1a', margin: 0 }}>0nGPT</h1>
              <p style={{ fontSize: 14, color: '#888', margin: 0 }}>ChatGPT App Integration for 0nMCP</p>
            </div>
          </div>
        ...
        {/* Files included */}
        <section style={{ marginBottom: 40 }}>
          <h2 style={{ fontSize: 22, fontWeight: 800, color: '#1a1a1a', marginBottom: 16 }}>Included Files</h2>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: 10 }}>
            <Link href="/signup" style={{ padding: '12px 28px', borderRadius: 10, background: '#fff', color: '#10a37f', fontWeight: 800, fontSize: 14, textDecoration: 'none' }}>Request Access</Link>
            <Link href="https://github.com/0nork/0nMCP" target="_blank" rel="noopener" style={{ padding: '12px 28px', borderRadius: 10, background: 'rgba(255,255,255,0.15)', color: '#fff', fontWeight: 600, fontSize: 14, textDecoration: 'none', border: '1px solid rgba(255,255,255,0.2)' }}>View Source</Link>
          </div>
        </div>
      </div>
    </div>
